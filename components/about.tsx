      ...
      <div className="max-w-(--breakpoint-xl) mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative h-[420px] rounded-2xl overflow-hidden border border-amber-500/20 shadow-2xl">
              <img
            ...
            {/* Floating Badge */}
            <div className="absolute -bottom-6 -right-2 sm:right-6 bg-zinc-900 border border-amber-400/30 p-4 rounded-xl shadow-xl flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-amber-400/10 border border-amber-400/40 flex items-center justify-center text-amber-400">
          ...
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-400/30 text-amber-400 text-xs font-semibold tracking-wider uppercase">
              The Atmosphere
            </div>

            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-zinc-100">
              Where Executive Polish Meets{" "}
              <span className="text-amber-400">Warm Hospitality</span>.
            </h2>
